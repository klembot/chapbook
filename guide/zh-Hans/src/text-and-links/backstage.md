...
当您在 Twine 编辑器中点击工具栏的“测试”按钮启动故事时，Chapbook 会启用 _后台视图_：这是一个位于故事界面侧边的面板，让您能够在以玩家身份体验故事的同时，窥探并调整其内部运行机制。本节将重点介绍后台视图中的“历史记录”与“笔记”标签页。其余标签页（“状态”与“样式”）将分别在本指南后续章节《[状态后台][state-backstage]》与《[页面样式][page-style]》中详细说明。
...
## 历史记录选项卡｜The History Tab

当你访问故事中的段落时，历史记录选项卡将以表格形式显示它们，最旧的位于顶部，最新的位于底部。
...
此标签页可用于记录当前阅读段落的笔记——包括拼写错误或任何其他想要记录的想法。这些笔记独立于故事本身存储，因此当多人协作撰写故事时，每位参与者均可保留各自的笔记。您输入的笔记将在键入时自动保存。  
